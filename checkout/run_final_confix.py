...
project = ['Chart', 'Lang', 'Math', 'Time', 'Closure']
...
for project_name in project:
    ...
    if project_name.lower() == 'chart':
        ...
        buggy_list = [1, 14, 38, 73, 92, 93, 109]
    ...
    for temp_buggy_num in buggy_list:
        ...
        os.system('/usr/bin/java -Xmx4g -cp ../../las.jar:/home/hjs/dldoldam/checkout/jarfolder/confix-0.0.1-SNAPSHOT-jar-with-dependencies_final_confix.jar -Duser.language=en -Duser.timezone=America/Los_Angeles com.github.thwak.confix.main.ConFix')
