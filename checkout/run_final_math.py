...
for project_name in project:
    ...
    for temp_buggy_num in buggy_list:
        ...
        os.system('/usr/bin/java -Xmx4g -cp ../../las.jar:/home/hjs/dldoldam/checkout/jarfolder/confix-0.0.1-SNAPSHOT-jar-with-dependencies_final_math.jar -Duser.language=en -Duser.timezone=America/Los_Angeles com.github.thwak.confix.main.ConFix')
