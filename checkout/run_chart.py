...
for project_name in project:
    ...
    for temp_buggy_num in range(10, 10 + 1):
        final_checkout_dir = checkout_dir + '/' + project_name.lower() + '_' + str(temp_buggy_num) + '_buggy'
        os.chdir(final_checkout_dir)
        os.system('/usr/bin/java -Xmx4g -cp ../../las.jar:/home/hjs/dldoldam/checkout/jarfolder/confix-0.0.1-SNAPSHOT-jar-with-dependencies_confix.jar -Duser.language=en -Duser.timezone=America/Los_Angeles com.github.thwak.confix.main.ConFix')