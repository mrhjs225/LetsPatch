...
fatal = open('/home/hjs/dldoldam/jinfix_database/jinseoktest.txt', 'w')
...
for path, dirs, files in os.walk(dir_patch_list):
    for f in files:
        ...
        if f in ['collections.patches', 'hama.patches', 'ivy.patches']:
            ...
            for ln, line in enumerate(lines):
                ...
                print('{:4d} {} {} {}'.format(ln + 1, patch_id, before_commit_id, after_commit_id))
                ...
                output_path = os.path.join(dir_output, patch_id.split('-')[0].lower())
                ...
                test_proc = subprocess.Popen(cmd.split(), stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                ...
                # run git diff
                cmd = 'git diff-tree --no-commit-id --name-only -r {} {}'.format(before_commit_id, after_commit_id)
                ...
                for t_file in target_files:
                    try:
                        ...
                        # print('[ERROR-COPY]')
                        with open(dir_projects + '/error.log', 'a') as log:
                            log.write('{} Inserted file {}\n'.format(before_commit_id, t_file))
                print('========================================')
